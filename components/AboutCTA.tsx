...
const AboutCTA = () => {
  return (
    <section className="bg-black px-14 py-16 border-t border-white/5 relative overflow-hidden max-md:px-6 max-md:py-12">
      <span
        className="hidden lg:block absolute -bottom-8 -right-4 font-bebas leading-none text-transparent pointer-events-none select-none"
        style={{
      ...
      <div className="relative z-10 max-w-2xl">
        ...
        <div className="flex items-center gap-6 flex-wrap">
          <Link
            href="/contact"
            className="rounded-lg font-bebas text-[0.85rem] tracking-[0.2em] uppercase text-black bg-white px-10 py-4 no-underline hover:bg-electric hover:text-white transition-colors"
          >
            Commission a Piece
          </Link>
          <Link
